...
class _CreatePageState extends State<CreatePage> {
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    ...
                                    color: _postBodyController.text.isEmpty? linkedInLightGreyDividerLineClr : linkedInBlue0077B5),
                              )
                            ],
                          ),
                        ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return FocusScope(
          ...
          child: Container(
            decoration: BoxDecoration(color: linkedInWhiteCardColor, boxShadow: [
              BoxShadow(
  ...
  _createSubPostNavigationItem({IconData? iconData, String? title}) {
    return Row(
      children: [
        Icon(iconData, size: 25,color: linkedInMediumGrey86888ATextColor,),
        const SizedBox(width: 10,),
        Text("$title", style:  TextStyle(fontSize: 16, color: linkedInMediumGrey86888ATextColor, fontWeight: FontWeight.bold),)
      ],
    );
  }
}
