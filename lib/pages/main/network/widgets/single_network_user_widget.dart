...
class SingleNetworkUserWidget extends StatefulWidget {
  ...
  const SingleNetworkUserWidget({key, required this.network});
        ...
        children: [
          Column(
            children: [
              Container(
                ...
                child: Image.network(widget.network.userBgImage!, fit: BoxFit.cover,),
              ),
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                child: Text("${widget.network.userBio}", maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: linkedInMediumGrey86888ATextColor),),
              ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: Text("${widget.network.mutualConnections} mutual connections", maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: linkedInMediumGrey86888ATextColor),))
                  ],
                ),
              ),
          ...
          Align(
            ...
            child: Container(
              ...
              child: ClipRRect(borderRadius: BorderRadius.circular(60),child: Image.network(widget.network.userProfileImage!, fit: BoxFit.cover,)),
            ),
          )
        ],
      ),
